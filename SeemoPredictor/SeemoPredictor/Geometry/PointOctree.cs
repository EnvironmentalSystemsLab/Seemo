...
namespace SeemoPredictor.Geometry
{
    ...
    /// Nodes have a constant - <see cref="PointOctree{T}.PointOctreeNode.NumObjectsAllowed"/> - which sets the amount of items allowed in a node before it splits.
    /// 
    /// </remarks>
    ...
    public class PointOctree<T>
    {
        ...
        /// </summary>
        private PointOctreeNode _rootNode;
        ...
        public PointOctree(float initialWorldSize, Point3 initialWorldPos, float minNodeSize)
        {
            ...
            _rootNode = new PointOctreeNode(_initialSize, _minSize, initialWorldPos);
        }
        ...
        private void Grow(Point3 direction)
        {
            ...
            PointOctreeNode oldRoot = _rootNode;
            ...
            _rootNode = new PointOctreeNode(newLength, _minSize, newCenter);
            ...
            if (oldRoot.HasAnyObjects())
            {
                ...
                for(int i = 0; i < 8; i++)
                {
                    ...
                    else
                    {
                        ...
                        children[i] = new PointOctreeNode(
                            oldRoot.SideLength,
                            _minSize,
        ...
        private class PointOctreeNode
        {
            ...
            /// Child nodes, if any
            /// </summary>
            private PointOctreeNode[] _children = null;
            ...
            public PointOctreeNode(float baseLengthVal, float minSizeVal, Point3 centerVal)
            {
            ...
            private void Split()
            {
                ...
                _children = new PointOctreeNode[8];
                _children[0] = new PointOctreeNode(newLength, _minSize, Center + new Point3(-quarter, quarter, -quarter));
                _children[1] = new PointOctreeNode(newLength, _minSize, Center + new Point3(quarter, quarter, -quarter));
                _children[2] = new PointOctreeNode(newLength, _minSize, Center + new Point3(-quarter, quarter, quarter));
                _children[3] = new PointOctreeNode(newLength, _minSize, Center + new Point3(quarter, quarter, quarter));
                _children[4] = new PointOctreeNode(newLength, _minSize, Center + new Point3(-quarter, -quarter, -quarter));
                _children[5] = new PointOctreeNode(newLength, _minSize, Center + new Point3(quarter, -quarter, -quarter));
                _children[6] = new PointOctreeNode(newLength, _minSize, Center + new Point3(-quarter, -quarter, quarter));
                _children[7] = new PointOctreeNode(newLength, _minSize, Center + new Point3(quarter, -quarter, quarter));
            }
            ...
            private void Merge()
            {
                ...
                for(int i = 0; i < 8; i++)
                {
                    PointOctreeNode curChild = _children[i];
            ...
            private bool ShouldMerge()
            {
                ...
                if (_children != null)
                {
                    foreach (PointOctreeNode child in _children)
                    {

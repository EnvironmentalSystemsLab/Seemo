...
namespace SeemoPredictor.SeemoGeo
{
    ...
    public struct SmoBBox
    {
        ...
        public void SetMinMax(SmoPoint3 min, SmoPoint3 max)
        {
        ...
        public void Encapsulate(SmoPoint3 point)
        {
            SetMinMax(SmoPoint3.Min(Min, point), SmoPoint3.Max(Max, point));
        }
        ...
        public void Encapsulate(SmoBBox box)
        {
        ...
        {
            amount *= 0.5f;
            Extents += new SmoPoint3(amount, amount, amount);
        }
        ...
        public void Expand(SmoPoint3 amount)
        {
            Extents += amount * 0.5f;
        }
        ...
        public bool Contains(SmoPoint3 point)
        {
            return
        ...
        public bool Intersects(SmoBBox box)
        {
            return
        ...
        public bool IntersectRay(SmoRay ray)
        {
            float distance;
        ...
        /// <returns><c>true</c> if the box intersects with the ray, <c>false</c> otherwise.</returns>
        public bool IntersectRay(SmoRay ray, out float distance)
        {
            SmoPoint3 dirFrac = new SmoPoint3(
                1f / ray.Direction.X,
                1f / ray.Direction.Y,
                1f / ray.Direction.Z
                );
        ...
        public static bool operator ==(SmoBBox lhs, SmoBBox rhs)
        {

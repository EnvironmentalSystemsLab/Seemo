...
namespace SeemoPredictor
{
    public class ViewAnalyzerComponent_ver2 : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            SmoPointOctree<SmoFace> octree0 = new SmoPointOctree<SmoFace>(1000.0f, input.Pts[0], 0.01f);
            ...
            for (int i = 0; i < input.Pts.Count; i++)
            {
                ...
                double floorheight;
                SmoPointOctree<SmoFace> octree1 = new SmoPointOctree<SmoFace>(1000.0f, input.Pts[0], 0.01f);
                ...
                */
                ...
                for (int j = 0; j < input.Vecs.Length; j++)
                {
                    ...
                    directionResult.ID = ("Room" + i.ToString() + ":" + "Point" + i.ToString() + ":" + "Dir" + j.ToString());

                    //Compute octree intersect
                    SmoIntersect.MeshRayResultSave(ref directionResult, octree0, node.Pt);
